...
public abstract class Soldier : ISoldier
{
    ...
    private const int Regeneration = 10;
    ...
    protected Soldier(string name, int age, double experience, double endurance)
    {
        ...
        this.Weapons = this.InitializeWepon();
    }
    ...
    public double Endurance
    {
        get => this.endurance;
        protected
        set => this.endurance = Math.Min(value, MaxEndurance);
    }
    ...
    private IDictionary<string, IAmmunition> InitializeWepon()
    {
    ...
    {
        this.Endurance += this.Age + Regeneration;
    }
